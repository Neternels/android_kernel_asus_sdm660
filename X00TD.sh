...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	msg "|| Cloning Anykernel ||"
        git clone https://github.com/ElectroPerf/AnyKernel3-X00TD.git -b ElectroPerf-R-Wifi AnyKernel3
...
setversioning() {
    # For staging branch
    KERNELNAME="ElectroPerf-$LINUXVER-R-WIFI-CAF-STABLE-X00TD-v2.1-$DATE"
...
gen_zip() {
	...
	cd AnyKernel3
	cp -af "$KERNEL_DIR"/init.ElectroSpectrum.rc init.spectrum.rc && sed -i "s/persist.spectrum.kernel.*/persist.spectrum.kernel ElectroPerf-R-WIFI-CAF-STABLE-v2.1/g" init.spectrum.rc
